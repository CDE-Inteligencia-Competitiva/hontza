...
<div style="clear:both;width:100%;">
  ...
  <div id="i-contenedor">
    ...
    <div class="item-canal">
        <span class="etiqueta-gris"><?php print t('Channel');?>: </span> <?php print hontza_get_canal_usuarios_title($node->uid); ?>
    </div>
    <?php endif;?>
    <?php if(hontza_is_con_botonera()):?>
        <div class="n-opciones-item">
            <div class="n-item-fuente">
                <?php print red_movil_noticia_usuario_web_link($node);?>
        </div>
        <?php if(!hontza_solr_search_is_usuario_lector()):?>
            ...
            <?php endif;?>
            <div class="n-item-movil-theme">
                <?php print red_movil_item_edit_link($node);?>
            </div>
        <?php endif;?>
        <?php $node_c_d_w='';?>    
