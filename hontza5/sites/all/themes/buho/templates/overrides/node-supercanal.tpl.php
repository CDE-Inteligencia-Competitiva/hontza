  ...
  <div class="content">
    <?php $my_user_info=my_get_user_info($node);?>
	  ...
	  <div style="float:left;clear:both;">
          ...
          <?php if(hontza_canal_rss_is_fuente_ficha_tabla()):?>
            <?php include('node-supercanal-table-view.tpl.php');?>
          <?php else:?>
          <?php if(!red_is_show_source_title()):?>
	  ...
	  <div class="field field-type-text field-field-supercanal-created" style="float:left;clear:both;">
		<div class="field-items">
			<div class="field-item odd">
				<div class="field-label-inline-first">
  	  ...
  	  <div class="field field-type-text field-field-supercanal-clasificaciones" style="float:left;clear:both;">
		<div class="field-items">			
			<div class="field-item odd">			
	  ...
	  <div class="field field-type-text field-field-supercanal-resumen" style="float:left;clear:both;">
		<div class="field-items">
			<div class="field-item odd">
				<div class="field-label-inline-first" style="float:left;">
				  <?php print t('Summary');?>:&nbsp;
	  ...
	  <div class="field field-type-text field-field-supercanal-fuente" style="float:left;clear:both;padding-top:10px;">
		<div class="field-items">
			<div class="field-item odd">
				<div class="field-label-inline-first">
				  <?php print t('Source');?>:&nbsp;
	   ...
	   <div class="field field-type-text field-field-supercanal-args" style="float:left;clear:both;">
		<div class="field-items">
			<div class="field-item odd">
				<div class="field-label-inline-first" style="float:left;">
	    ...
	    <div class="field field-type-text field-field-supercanal-args-desc" style="float:left;clear:both;">
		<div class="field-items">
			<div class="field-item odd">
				<div class="field-label-inline-first" style="float:left;">
				  <?php //print t(utf8_encode('Description of Parameters'));?>
          ...
          <div class="field field-type-text field-field-supercanal-quality" style="float:left;clear:both;">
		<div class="field-items">
			<div class="field-item odd">
				<div class="field-label-inline-first" style="float:left;">
				  <?php print t('Quality');?>:&nbsp;
				</div>
				<?php print hontza_get_fuente_stars_view($node,'field_supercanal_calidad');?>
			</div>
		</div>
	  </div>
      
          <div class="field field-type-text field-field-supercanal-coverage" style="float:left;clear:both;">
		<div class="field-items">
			<div class="field-item odd">
				<div class="field-label-inline-first" style="float:left;">
				  <?php print t('Coverage');?>:&nbsp;
				</div>
				<?php print hontza_get_fuente_stars_view($node,'field_supercanal_exhaustividad');?>
			</div>
		</div>
	  </div>
		...
		<div class="field-items">
			<div class="field-item odd">
				...
				<?php print hontza_get_fuente_stars_view($node,'field_supercanal_actualizacion');?>
			</div>
		</div>
	  </div>
          ...
          <?php if(hontza_is_sareko_id_red()):?>
                <?php include('red-supercanal_fields_view.tpl.php');?>
          <?php endif;?>
	   ...
	   <div class="field field-type-text field-tematica-gupos" style="float:left;clear:both;">
		<div class="field-items">
          ...
          <?php endif;?>
          <?php //print hontza_red_compartir_fuente_link($node);?>
  				...
  				<div class="item-comentar">
					<?php print hontza_fuente_comment_link($node);?>
					 ...
					 <?php print hontza_fuente_edit_link($node);?>
                                ...
                                <?php $compartir_fuente_link=hontza_red_compartir_fuente_link($node);?>
                                
                                <?php if(!empty($compartir_fuente_link)):?> 
                                    <div class="item-compartir-fuente">
                                        <?php print $compartir_fuente_link;?>
                                    </div>
                                <?php endif;?>    
