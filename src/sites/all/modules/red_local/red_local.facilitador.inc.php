<?php
function red_local_facilitadores_local_callback(){
    ...
    $where=array();
    $where[]='1';
    $res=db_query('SELECT fa.* FROM {red_compartir_facilitador} fa WHERE '.implode(' AND ',$where).' ORDER BY fa.fecha DESC');    
    //
    $kont=0;
    $rows=array();
...
function red_local_facilitador_local_define_acciones($r){
    $html=array();
