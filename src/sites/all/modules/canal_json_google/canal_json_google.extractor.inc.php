<?php
function canal_json_google_google_extractor_get_result($extractor){
    if(canal_json_google_extractor_is_extractor($extractor)){
        $result='';
        /*echo print_r($extractor,1);
        exit();*/        
        //if(canal_json_google_extractor_is_extractor_data_array($extractor)){
             $result=canal_json_google_google_extractor_get_result_data_array($extractor);
        //}
...
function canal_json_google_extractor_is_extractor($extractor){
    if(isset($extractor->extractorData) && !empty($extractor->extractorData)){
        return 1;
    }
    return 0;
}
function canal_json_google_extractor_is_activado(){
    /*if(defined('_IS_canal_json_google_EXTRACTOR') && _IS_canal_json_google_EXTRACTOR==1){
        return 1;
    }
    return 0;*/
    return 1;
}
function canal_json_google_extractor_is_extractor_data_array($extractor){
...
function canal_json_google_extractor_get_result_data_array($extractor){
    $result=new stdClass();
        $kont=0;
