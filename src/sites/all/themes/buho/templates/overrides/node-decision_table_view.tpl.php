<table class="table_node_view" style="clear:both;">
    ...
    <?php if(!estrategia_is_grupo_estrellas()):?>
        <tr class="tr_node_view">
            <td class="td_label_node_view"><b><?php print t('Value of Decision');?></b>:&nbsp;</td>
            <td class="td_value_node_view"><?php print get_eval_label($node->valor_decision, 'valor_decision');?></td>
        </tr>
    <?php endif;?>
    <tr class="tr_node_view">
