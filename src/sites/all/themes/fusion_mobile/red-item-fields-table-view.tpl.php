...
<tr class="tr_node_view">        
    ...
    <td class="td_value_node_view"><?php print red_field($node,'field_igape_item_web');?></td>
</tr>
<tr class="tr_node_view">        
...
<tr class="tr_node_view">        
    ...
    <td class="td_value_node_view"><?php print red_field($node,'field_igape_fuente_de_la_noticia');?></td>
</tr>
<tr class="tr_node_view">        
