...
$db_url['hontza_solr'] = 'mysql://hontza:hontzacde@localhost/hontza_solr';
$db_url['hontza_biko'] = 'mysql://hontza:hontzacde@localhost/hontza_biko';
$db_url['hontza_lhusurbil'] = 'mysql://hontza:hontzacde@localhost/hontza_lhusurbil';
